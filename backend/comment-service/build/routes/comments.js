...
router.put('/:commentId', comments_1.editComment);
router.delete('/:questionId', comments_1.removeAllComments);
router.delete('/:questionId/:commentId', comments_1.removeComment);
